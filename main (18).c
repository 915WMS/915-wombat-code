...
int main()
{
    ...
    msleep(300);
    motor(0, 0);
    msleep(800); // Turns right to drop the pom-poms
    motor(0, -100);
    motor(3, -100);
    msleep(300);
    motor(0, 0);
    ...
    msleep(700); // Opens the claw to drop the pom-poms
    motor(0, 100);
    motor(3, 100);
    msleep(300);
    motor(0, -100);
    motor(3, 0);
    msleep(1040); // Turns left to grab another 3 pom-poms
    motor(0, 0);
    set_servo_position(3, 1542);
    msleep(600);
    motor(0, -100);
    ...
    msleep(1100);
    motor(3, 0);
    msleep(890);  // Turns right to drop the next batch of pom-poms
    motor(0, -100);
    motor(3, -100);
    msleep(300); // Drive forward to drop the next batch of pom-poms
    motor(0, 0);
    motor(3, 0);
